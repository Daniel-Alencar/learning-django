...
def add(request):
  ...
  if request.method == "POST":
    ...
    if form.is_valid():
      ...
      # Renderizamos o mesmo arquivo add.html, mas com o mesmo formulário que foi preenchido. Assim, é possível visualizar todos os erros cometidos no preenchimento
      return render(request, "tasks/add.html", {
        "form": form
      })
  # Caso o método seja GET, significa que o usuário apenas tentou obter a página em vez de enviar dados a ela. Assim, enviamos apenas um formulário vazio
  return render(request, "tasks/add.html", {
    "form": NewTaskForm()
  })
